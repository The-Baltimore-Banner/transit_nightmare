...
positions_url = 'https://api.goswift.ly/real-time/mta-maryland-metro/gtfs-rt-vehicle-positions'
...
def fetch_vehicle_positions():
    ...
    if positions_response.status_code != 200:
        ...
        if not hour_folder_exists.get('Contents'):
            ...
            new_folder_message = f':white_check_mark:  <{s3_link}|New subway folder.>\n\nCreated at {finish_timestamp}'
