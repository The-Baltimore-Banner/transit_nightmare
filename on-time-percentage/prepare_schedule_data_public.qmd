      ...
      for(id in route_ids) {
        ...
        schedule_response <- 
          VERB("GET", schedule_url, query = schedule_queryString, 
               add_headers('Authorization' = 'YOUR-API-KEY-HERE'), 
...
# Combine all the schedules into one large data frame
# full_schedule_df <- rbindlist(full_schedules, use.names = TRUE)

# full_schedule_df %>% 
#   write_csv(here::here("data", "full_schedule_df_8_26_through_9_12.csv"))
