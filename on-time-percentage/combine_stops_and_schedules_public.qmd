---
title: "combine stops and schedules"
editor: visual
---
...
# IMPORTANT: make sure you replace the placeholder API keys in the script below with your own.
...
#   # if stops don't have a scheduled time, that means they aren't scheduled (I assume)
  ...
  mutate(
    ...
    on_time_5 = ifelse(as.numeric(timestamp_2 - schedtime) >= -120 & as.numeric(timestamp_2 - schedtime) <= 300, TRUE, FALSE),
    on_time_3 = ifelse(as.numeric(timestamp_2 - schedtime) >= -120 & as.numeric(timestamp_2 - schedtime) <= 180, TRUE, FALSE),
    ...
    late_3 = ifelse(as.numeric(timestamp_2 - schedtime) > 180, TRUE, FALSE),
...
morning_otp %>% 
  ...
  write_csv("data/output/morning_otp_01_28.csv")
...
afternoon_otp %>% 
  ...
  write_csv("data/output/afternoon_otp_01_28.csv")
...
morning_otp_line <- 
  ...
  write_csv("data/output/morning_otp_by_line_01_28.csv")
